...
cccdlflags=' '
ccdlflags=' '
ccflags='-DPERL_USE_SAFE_PUTENV -U__STRICT_ANSI__ -D_GNU_SOURCE -march=i686 -mtune=generic -O2 -pipe -fwrapv -fno-strict-aliasing -fstack-protector-strong'
...
cf_by='Alexx'
cf_email=''
cf_time='Tue Nov 12 11:51:10 MSK 2019'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
incpath=''
incpth='/usr/lib/gcc/i686-pc-msys/9.1.0/include /usr/include'
inews=''
...
mydomain='.nonet'
myhostname='warlock'
myuname='msys_nt-6.1-7601-wow64 warlock 3.0.7-338.i686 2019-07-11 11:17 utc i686 msys '
n='-n'
need_va_copy='undef'
netdb_hlen_type='int'
...
ccflags_nolargefiles='-DPERL_USE_SAFE_PUTENV -U__STRICT_ANSI__ -D_GNU_SOURCE -march=i686 -mtune=generic -O2 -pipe -fwrapv -fno-strict-aliasing -fstack-protector-strong'
