#!C:/Users/old_w/Documents/GitHub/ProxSpace/msys2/mingw32/bin/python3.exe
...
if not os.path.isfile(os.path.join(path, 'codegen', 'codegen_main.py')):
    path = os.path.join('C:/Users/old_w/Documents/GitHub/ProxSpace/msys2/mingw32/share', 'glib-2.0')
