...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    _populate_RemoteObjects_target_properties(RELEASE "Qt5RemoteObjects.dll" "libQt5RemoteObjects.dll.a" FALSE)

    if (EXISTS
        "${_qt5RemoteObjects_install_prefix}/bin/Qt5RemoteObjects.dll"
      AND EXISTS
        "${_qt5RemoteObjects_install_prefix}/lib/libQt5RemoteObjects.dll.a" )
        _populate_RemoteObjects_target_properties(DEBUG "Qt5RemoteObjects.dll" "libQt5RemoteObjects.dll.a" FALSE)
    endif()
    ...
    macro(_populate_RemoteObjects_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5RemoteObjects_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_RemoteObjects_check_file_exists(${imported_location})
