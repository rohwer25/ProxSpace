...
if (NOT TARGET Qt5::3DCore)
    ...
    _populate_3DCore_target_properties(RELEASE "Qt53DCore.dll" "libQt53DCore.dll.a" FALSE)

    if (EXISTS
        "${_qt53DCore_install_prefix}/bin/Qt53DCore.dll"
      AND EXISTS
        "${_qt53DCore_install_prefix}/lib/libQt53DCore.dll.a" )
        _populate_3DCore_target_properties(DEBUG "Qt53DCore.dll" "libQt53DCore.dll.a" FALSE)
    endif()
