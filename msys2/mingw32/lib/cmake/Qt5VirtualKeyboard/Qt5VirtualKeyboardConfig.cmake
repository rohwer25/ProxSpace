...
set(Qt5VirtualKeyboard_VERSION_STRING 5.14.1)
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    set(Qt5VirtualKeyboard_PRIVATE_INCLUDE_DIRS
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.14.1"
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.14.1/QtVirtualKeyboard"
    )
    ...
    foreach(_module_dep ${_Qt5VirtualKeyboard_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.1 ${_Qt5VirtualKeyboard_FIND_VERSION_EXACT}
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "Qt5VirtualKeyboard.dll" "libQt5VirtualKeyboard.dll.a" FALSE)

    if (EXISTS
        "${_qt5VirtualKeyboard_install_prefix}/bin/Qt5VirtualKeyboard.dll"
      AND EXISTS
        "${_qt5VirtualKeyboard_install_prefix}/lib/libQt5VirtualKeyboard.dll.a" )
        _populate_VirtualKeyboard_target_properties(DEBUG "Qt5VirtualKeyboard.dll" "libQt5VirtualKeyboard.dll.a" FALSE)
    endif()
    ...
    macro(_populate_VirtualKeyboard_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5VirtualKeyboard_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_VirtualKeyboard_check_file_exists(${imported_location})
