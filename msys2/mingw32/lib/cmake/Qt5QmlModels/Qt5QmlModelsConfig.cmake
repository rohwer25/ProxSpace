...
if (NOT TARGET Qt5::QmlModels)
    ...
    _populate_QmlModels_target_properties(RELEASE "Qt5QmlModels.dll" "libQt5QmlModels.dll.a" FALSE)

    if (EXISTS
        "${_qt5QmlModels_install_prefix}/bin/Qt5QmlModels.dll"
      AND EXISTS
        "${_qt5QmlModels_install_prefix}/lib/libQt5QmlModels.dll.a" )
        _populate_QmlModels_target_properties(DEBUG "Qt5QmlModels.dll" "libQt5QmlModels.dll.a" FALSE)
    endif()
    ...
    macro(_populate_QmlModels_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QmlModels_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QmlModels_check_file_exists(${imported_location})
