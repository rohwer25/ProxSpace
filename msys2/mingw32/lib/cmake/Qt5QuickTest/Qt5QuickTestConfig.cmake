...
if (NOT TARGET Qt5::QuickTest)
    ...
    _populate_QuickTest_target_properties(RELEASE "Qt5QuickTest.dll" "libQt5QuickTest.dll.a" FALSE)

    if (EXISTS
        "${_qt5QuickTest_install_prefix}/bin/Qt5QuickTest.dll"
      AND EXISTS
        "${_qt5QuickTest_install_prefix}/lib/libQt5QuickTest.dll.a" )
        _populate_QuickTest_target_properties(DEBUG "Qt5QuickTest.dll" "libQt5QuickTest.dll.a" FALSE)
    endif()
