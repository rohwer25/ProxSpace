...
if (NOT TARGET Qt5::Positioning)
    ...
    _populate_Positioning_target_properties(RELEASE "Qt5Positioning.dll" "libQt5Positioning.dll.a" FALSE)

    if (EXISTS
        "${_qt5Positioning_install_prefix}/bin/Qt5Positioning.dll"
      AND EXISTS
        "${_qt5Positioning_install_prefix}/lib/libQt5Positioning.dll.a" )
        _populate_Positioning_target_properties(DEBUG "Qt5Positioning.dll" "libQt5Positioning.dll.a" FALSE)
    endif()
