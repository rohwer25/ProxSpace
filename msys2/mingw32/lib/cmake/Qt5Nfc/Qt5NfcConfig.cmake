...
if (NOT TARGET Qt5::Nfc)
    ...
    _populate_Nfc_target_properties(RELEASE "Qt5Nfc.dll" "libQt5Nfc.dll.a" FALSE)

    if (EXISTS
        "${_qt5Nfc_install_prefix}/bin/Qt5Nfc.dll"
      AND EXISTS
        "${_qt5Nfc_install_prefix}/lib/libQt5Nfc.dll.a" )
        _populate_Nfc_target_properties(DEBUG "Qt5Nfc.dll" "libQt5Nfc.dll.a" FALSE)
    endif()
