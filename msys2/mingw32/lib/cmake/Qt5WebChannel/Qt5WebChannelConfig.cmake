...
if (NOT TARGET Qt5::WebChannel)
    ...
    _populate_WebChannel_target_properties(RELEASE "Qt5WebChannel.dll" "libQt5WebChannel.dll.a" FALSE)

    if (EXISTS
        "${_qt5WebChannel_install_prefix}/bin/Qt5WebChannel.dll"
      AND EXISTS
        "${_qt5WebChannel_install_prefix}/lib/libQt5WebChannel.dll.a" )
        _populate_WebChannel_target_properties(DEBUG "Qt5WebChannel.dll" "libQt5WebChannel.dll.a" FALSE)
    endif()
