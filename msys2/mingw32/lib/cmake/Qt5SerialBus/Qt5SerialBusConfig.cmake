...
if (NOT TARGET Qt5::SerialBus)
    ...
    _populate_SerialBus_target_properties(RELEASE "Qt5SerialBus.dll" "libQt5SerialBus.dll.a" FALSE)

    if (EXISTS
        "${_qt5SerialBus_install_prefix}/bin/Qt5SerialBus.dll"
      AND EXISTS
        "${_qt5SerialBus_install_prefix}/lib/libQt5SerialBus.dll.a" )
        _populate_SerialBus_target_properties(DEBUG "Qt5SerialBus.dll" "libQt5SerialBus.dll.a" FALSE)
    endif()
