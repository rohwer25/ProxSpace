...
if (NOT TARGET Qt5::3DInput)
    ...
    _populate_3DInput_target_properties(RELEASE "Qt53DInput.dll" "libQt53DInput.dll.a" FALSE)

    if (EXISTS
        "${_qt53DInput_install_prefix}/bin/Qt53DInput.dll"
      AND EXISTS
        "${_qt53DInput_install_prefix}/lib/libQt53DInput.dll.a" )
        _populate_3DInput_target_properties(DEBUG "Qt53DInput.dll" "libQt53DInput.dll.a" FALSE)
    endif()
