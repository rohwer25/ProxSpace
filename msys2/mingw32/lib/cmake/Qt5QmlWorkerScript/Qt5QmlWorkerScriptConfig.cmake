...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    _populate_QmlWorkerScript_target_properties(RELEASE "Qt5QmlWorkerScript.dll" "libQt5QmlWorkerScript.dll.a" FALSE)

    if (EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/bin/Qt5QmlWorkerScript.dll"
      AND EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/lib/libQt5QmlWorkerScript.dll.a" )
        _populate_QmlWorkerScript_target_properties(DEBUG "Qt5QmlWorkerScript.dll" "libQt5QmlWorkerScript.dll.a" FALSE)
    endif()
    ...
    macro(_populate_QmlWorkerScript_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QmlWorkerScript_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QmlWorkerScript_check_file_exists(${imported_location})
