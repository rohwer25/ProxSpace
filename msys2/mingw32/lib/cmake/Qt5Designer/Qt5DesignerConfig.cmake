...
if (NOT TARGET Qt5::Designer)
    ...
    _populate_Designer_target_properties(RELEASE "Qt5Designer.dll" "libQt5Designer.dll.a" FALSE)

    if (EXISTS
        "${_qt5Designer_install_prefix}/bin/Qt5Designer.dll"
      AND EXISTS
        "${_qt5Designer_install_prefix}/lib/libQt5Designer.dll.a" )
        _populate_Designer_target_properties(DEBUG "Qt5Designer.dll" "libQt5Designer.dll.a" FALSE)
    endif()
