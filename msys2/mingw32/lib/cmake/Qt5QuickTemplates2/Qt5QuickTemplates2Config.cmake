...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    _populate_QuickTemplates2_target_properties(RELEASE "Qt5QuickTemplates2.dll" "libQt5QuickTemplates2.dll.a" FALSE)

    if (EXISTS
        "${_qt5QuickTemplates2_install_prefix}/bin/Qt5QuickTemplates2.dll"
      AND EXISTS
        "${_qt5QuickTemplates2_install_prefix}/lib/libQt5QuickTemplates2.dll.a" )
        _populate_QuickTemplates2_target_properties(DEBUG "Qt5QuickTemplates2.dll" "libQt5QuickTemplates2.dll.a" FALSE)
    endif()
    ...
    macro(_populate_QuickTemplates2_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QuickTemplates2_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickTemplates2_check_file_exists(${imported_location})
