...
if (NOT TARGET Qt5::Location)
    ...
    _populate_Location_target_properties(RELEASE "Qt5Location.dll" "libQt5Location.dll.a" FALSE)

    if (EXISTS
        "${_qt5Location_install_prefix}/bin/Qt5Location.dll"
      AND EXISTS
        "${_qt5Location_install_prefix}/lib/libQt5Location.dll.a" )
        _populate_Location_target_properties(DEBUG "Qt5Location.dll" "libQt5Location.dll.a" FALSE)
    endif()
