...
if (NOT TARGET Qt5::3DQuickAnimation)
    ...
    _populate_3DQuickAnimation_target_properties(RELEASE "Qt53DQuickAnimation.dll" "libQt53DQuickAnimation.dll.a" FALSE)

    if (EXISTS
        "${_qt53DQuickAnimation_install_prefix}/bin/Qt53DQuickAnimation.dll"
      AND EXISTS
        "${_qt53DQuickAnimation_install_prefix}/lib/libQt53DQuickAnimation.dll.a" )
        _populate_3DQuickAnimation_target_properties(DEBUG "Qt53DQuickAnimation.dll" "libQt53DQuickAnimation.dll.a" FALSE)
    endif()
    ...
    macro(_populate_3DQuickAnimation_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DQuickAnimation_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_3DQuickAnimation_check_file_exists(${imported_location})
