...
if (NOT TARGET Qt5::ScriptTools)
    ...
    _populate_ScriptTools_target_properties(RELEASE "Qt5ScriptTools.dll" "libQt5ScriptTools.dll.a" FALSE)

    if (EXISTS
        "${_qt5ScriptTools_install_prefix}/bin/Qt5ScriptTools.dll"
      AND EXISTS
        "${_qt5ScriptTools_install_prefix}/lib/libQt5ScriptTools.dll.a" )
        _populate_ScriptTools_target_properties(DEBUG "Qt5ScriptTools.dll" "libQt5ScriptTools.dll.a" FALSE)
    endif()
