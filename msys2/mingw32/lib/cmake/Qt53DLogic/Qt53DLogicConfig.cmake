...
if (NOT TARGET Qt5::3DLogic)
    ...
    _populate_3DLogic_target_properties(RELEASE "Qt53DLogic.dll" "libQt53DLogic.dll.a" FALSE)

    if (EXISTS
        "${_qt53DLogic_install_prefix}/bin/Qt53DLogic.dll"
      AND EXISTS
        "${_qt53DLogic_install_prefix}/lib/libQt53DLogic.dll.a" )
        _populate_3DLogic_target_properties(DEBUG "Qt53DLogic.dll" "libQt53DLogic.dll.a" FALSE)
    endif()
