...
if (NOT TARGET Qt5::Scxml)
    ...
    _populate_Scxml_target_properties(RELEASE "Qt5Scxml.dll" "libQt5Scxml.dll.a" FALSE)

    if (EXISTS
        "${_qt5Scxml_install_prefix}/bin/Qt5Scxml.dll"
      AND EXISTS
        "${_qt5Scxml_install_prefix}/lib/libQt5Scxml.dll.a" )
        _populate_Scxml_target_properties(DEBUG "Qt5Scxml.dll" "libQt5Scxml.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Scxml_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Scxml_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Scxml_check_file_exists(${imported_location})
