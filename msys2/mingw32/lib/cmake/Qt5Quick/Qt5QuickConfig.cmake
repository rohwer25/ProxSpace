...
if (NOT TARGET Qt5::Quick)
    ...
    _populate_Quick_target_properties(RELEASE "Qt5Quick.dll" "libQt5Quick.dll.a" FALSE)

    if (EXISTS
        "${_qt5Quick_install_prefix}/bin/Qt5Quick.dll"
      AND EXISTS
        "${_qt5Quick_install_prefix}/lib/libQt5Quick.dll.a" )
        _populate_Quick_target_properties(DEBUG "Qt5Quick.dll" "libQt5Quick.dll.a" FALSE)
    endif()
