...
set(Qt5Bodymovin_VERSION_STRING 5.14.1)
...
if (NOT TARGET Qt5::Bodymovin)
    ...
    set(Qt5Bodymovin_PRIVATE_INCLUDE_DIRS
        "${_qt5Bodymovin_install_prefix}/include/QtBodymovin/5.14.1"
        "${_qt5Bodymovin_install_prefix}/include/QtBodymovin/5.14.1/QtBodymovin"
    )
    ...
    foreach(_module_dep ${_Qt5Bodymovin_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.1 ${_Qt5Bodymovin_FIND_VERSION_EXACT}
    ...
    _populate_Bodymovin_target_properties(RELEASE "Qt5Bodymovin.dll" "libQt5Bodymovin.dll.a" FALSE)

    if (EXISTS
        "${_qt5Bodymovin_install_prefix}/bin/Qt5Bodymovin.dll"
      AND EXISTS
        "${_qt5Bodymovin_install_prefix}/lib/libQt5Bodymovin.dll.a" )
        _populate_Bodymovin_target_properties(DEBUG "Qt5Bodymovin.dll" "libQt5Bodymovin.dll.a" FALSE)
    endif()
