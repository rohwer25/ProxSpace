...
if (NOT TARGET Qt5::Help)
    ...
    _populate_Help_target_properties(RELEASE "Qt5Help.dll" "libQt5Help.dll.a" FALSE)

    if (EXISTS
        "${_qt5Help_install_prefix}/bin/Qt5Help.dll"
      AND EXISTS
        "${_qt5Help_install_prefix}/lib/libQt5Help.dll.a" )
        _populate_Help_target_properties(DEBUG "Qt5Help.dll" "libQt5Help.dll.a" FALSE)
    endif()
