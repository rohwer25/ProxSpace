...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    _populate_3DQuickRender_target_properties(RELEASE "Qt53DQuickRender.dll" "libQt53DQuickRender.dll.a" FALSE)

    if (EXISTS
        "${_qt53DQuickRender_install_prefix}/bin/Qt53DQuickRender.dll"
      AND EXISTS
        "${_qt53DQuickRender_install_prefix}/lib/libQt53DQuickRender.dll.a" )
        _populate_3DQuickRender_target_properties(DEBUG "Qt53DQuickRender.dll" "libQt53DQuickRender.dll.a" FALSE)
    endif()
