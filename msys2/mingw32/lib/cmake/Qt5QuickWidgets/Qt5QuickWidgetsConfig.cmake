...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    _populate_QuickWidgets_target_properties(RELEASE "Qt5QuickWidgets.dll" "libQt5QuickWidgets.dll.a" FALSE)

    if (EXISTS
        "${_qt5QuickWidgets_install_prefix}/bin/Qt5QuickWidgets.dll"
      AND EXISTS
        "${_qt5QuickWidgets_install_prefix}/lib/libQt5QuickWidgets.dll.a" )
        _populate_QuickWidgets_target_properties(DEBUG "Qt5QuickWidgets.dll" "libQt5QuickWidgets.dll.a" FALSE)
    endif()
