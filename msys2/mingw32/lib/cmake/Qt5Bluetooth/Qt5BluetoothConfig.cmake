...
if (NOT TARGET Qt5::Bluetooth)
    ...
    _populate_Bluetooth_target_properties(RELEASE "Qt5Bluetooth.dll" "libQt5Bluetooth.dll.a" FALSE)

    if (EXISTS
        "${_qt5Bluetooth_install_prefix}/bin/Qt5Bluetooth.dll"
      AND EXISTS
        "${_qt5Bluetooth_install_prefix}/lib/libQt5Bluetooth.dll.a" )
        _populate_Bluetooth_target_properties(DEBUG "Qt5Bluetooth.dll" "libQt5Bluetooth.dll.a" FALSE)
    endif()
