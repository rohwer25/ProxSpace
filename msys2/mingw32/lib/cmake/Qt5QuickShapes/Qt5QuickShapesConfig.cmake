...
if (NOT TARGET Qt5::QuickShapes)
    ...
    _populate_QuickShapes_target_properties(RELEASE "Qt5QuickShapes.dll" "libQt5QuickShapes.dll.a" FALSE)

    if (EXISTS
        "${_qt5QuickShapes_install_prefix}/bin/Qt5QuickShapes.dll"
      AND EXISTS
        "${_qt5QuickShapes_install_prefix}/lib/libQt5QuickShapes.dll.a" )
        _populate_QuickShapes_target_properties(DEBUG "Qt5QuickShapes.dll" "libQt5QuickShapes.dll.a" FALSE)
    endif()
