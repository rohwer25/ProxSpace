...
if (NOT TARGET Qt5::WinExtras)
    ...
    _populate_WinExtras_target_properties(RELEASE "Qt5WinExtras.dll" "libQt5WinExtras.dll.a" FALSE)

    if (EXISTS
        "${_qt5WinExtras_install_prefix}/bin/Qt5WinExtras.dll"
      AND EXISTS
        "${_qt5WinExtras_install_prefix}/lib/libQt5WinExtras.dll.a" )
        _populate_WinExtras_target_properties(DEBUG "Qt5WinExtras.dll" "libQt5WinExtras.dll.a" FALSE)
    endif()
