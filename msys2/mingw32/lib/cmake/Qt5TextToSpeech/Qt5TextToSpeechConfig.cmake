...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    _populate_TextToSpeech_target_properties(RELEASE "Qt5TextToSpeech.dll" "libQt5TextToSpeech.dll.a" FALSE)

    if (EXISTS
        "${_qt5TextToSpeech_install_prefix}/bin/Qt5TextToSpeech.dll"
      AND EXISTS
        "${_qt5TextToSpeech_install_prefix}/lib/libQt5TextToSpeech.dll.a" )
        _populate_TextToSpeech_target_properties(DEBUG "Qt5TextToSpeech.dll" "libQt5TextToSpeech.dll.a" FALSE)
    endif()
    ...
    macro(_populate_TextToSpeech_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5TextToSpeech_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_TextToSpeech_check_file_exists(${imported_location})
