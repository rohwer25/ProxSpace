...
if (NOT TARGET Qt5::SerialPort)
    ...
    _populate_SerialPort_target_properties(RELEASE "Qt5SerialPort.dll" "libQt5SerialPort.dll.a" FALSE)

    if (EXISTS
        "${_qt5SerialPort_install_prefix}/bin/Qt5SerialPort.dll"
      AND EXISTS
        "${_qt5SerialPort_install_prefix}/lib/libQt5SerialPort.dll.a" )
        _populate_SerialPort_target_properties(DEBUG "Qt5SerialPort.dll" "libQt5SerialPort.dll.a" FALSE)
    endif()
