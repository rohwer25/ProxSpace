...
if (NOT TARGET Qt5::Charts)
    ...
    _populate_Charts_target_properties(RELEASE "Qt5Charts.dll" "libQt5Charts.dll.a" FALSE)

    if (EXISTS
        "${_qt5Charts_install_prefix}/bin/Qt5Charts.dll"
      AND EXISTS
        "${_qt5Charts_install_prefix}/lib/libQt5Charts.dll.a" )
        _populate_Charts_target_properties(DEBUG "Qt5Charts.dll" "libQt5Charts.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Charts_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Charts_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Charts_check_file_exists(${imported_location})
