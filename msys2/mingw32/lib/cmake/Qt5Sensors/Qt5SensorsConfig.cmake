...
if (NOT TARGET Qt5::Sensors)
    ...
    _populate_Sensors_target_properties(RELEASE "Qt5Sensors.dll" "libQt5Sensors.dll.a" FALSE)

    if (EXISTS
        "${_qt5Sensors_install_prefix}/bin/Qt5Sensors.dll"
      AND EXISTS
        "${_qt5Sensors_install_prefix}/lib/libQt5Sensors.dll.a" )
        _populate_Sensors_target_properties(DEBUG "Qt5Sensors.dll" "libQt5Sensors.dll.a" FALSE)
    endif()
