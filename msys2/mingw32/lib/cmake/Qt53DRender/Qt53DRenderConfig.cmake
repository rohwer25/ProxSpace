...
if (NOT TARGET Qt5::3DRender)
    ...
    _populate_3DRender_target_properties(RELEASE "Qt53DRender.dll" "libQt53DRender.dll.a" FALSE)

    if (EXISTS
        "${_qt53DRender_install_prefix}/bin/Qt53DRender.dll"
      AND EXISTS
        "${_qt53DRender_install_prefix}/lib/libQt53DRender.dll.a" )
        _populate_3DRender_target_properties(DEBUG "Qt53DRender.dll" "libQt53DRender.dll.a" FALSE)
    endif()
