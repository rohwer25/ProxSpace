...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    _populate_MultimediaWidgets_target_properties(RELEASE "Qt5MultimediaWidgets.dll" "libQt5MultimediaWidgets.dll.a" FALSE)

    if (EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/bin/Qt5MultimediaWidgets.dll"
      AND EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/lib/libQt5MultimediaWidgets.dll.a" )
        _populate_MultimediaWidgets_target_properties(DEBUG "Qt5MultimediaWidgets.dll" "libQt5MultimediaWidgets.dll.a" FALSE)
    endif()
