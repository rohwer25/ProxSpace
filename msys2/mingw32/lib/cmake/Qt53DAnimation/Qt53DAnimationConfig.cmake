...
if (NOT TARGET Qt5::3DAnimation)
    ...
    _populate_3DAnimation_target_properties(RELEASE "Qt53DAnimation.dll" "libQt53DAnimation.dll.a" FALSE)

    if (EXISTS
        "${_qt53DAnimation_install_prefix}/bin/Qt53DAnimation.dll"
      AND EXISTS
        "${_qt53DAnimation_install_prefix}/lib/libQt53DAnimation.dll.a" )
        _populate_3DAnimation_target_properties(DEBUG "Qt53DAnimation.dll" "libQt53DAnimation.dll.a" FALSE)
    endif()
    ...
    macro(_populate_3DAnimation_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DAnimation_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_3DAnimation_check_file_exists(${imported_location})
