...
if (NOT TARGET Qt5::Purchasing)
    ...
    _populate_Purchasing_target_properties(RELEASE "Qt5Purchasing.dll" "libQt5Purchasing.dll.a" FALSE)

    if (EXISTS
        "${_qt5Purchasing_install_prefix}/bin/Qt5Purchasing.dll"
      AND EXISTS
        "${_qt5Purchasing_install_prefix}/lib/libQt5Purchasing.dll.a" )
        _populate_Purchasing_target_properties(DEBUG "Qt5Purchasing.dll" "libQt5Purchasing.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Purchasing_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Purchasing_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Purchasing_check_file_exists(${imported_location})
