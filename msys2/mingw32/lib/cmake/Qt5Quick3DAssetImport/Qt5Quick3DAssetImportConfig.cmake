...
set(Qt5Quick3DAssetImport_VERSION_STRING 5.14.1)
...
if (NOT TARGET Qt5::Quick3DAssetImport)
    ...
    set(Qt5Quick3DAssetImport_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DAssetImport_install_prefix}/include/QtQuick3DAssetImport/5.14.1"
        "${_qt5Quick3DAssetImport_install_prefix}/include/QtQuick3DAssetImport/5.14.1/QtQuick3DAssetImport"
    )
    ...
    foreach(_module_dep ${_Qt5Quick3DAssetImport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.1 ${_Qt5Quick3DAssetImport_FIND_VERSION_EXACT}
    ...
    _populate_Quick3DAssetImport_target_properties(RELEASE "Qt5Quick3DAssetImport.dll" "libQt5Quick3DAssetImport.dll.a" FALSE)

    if (EXISTS
        "${_qt5Quick3DAssetImport_install_prefix}/bin/Qt5Quick3DAssetImport.dll"
      AND EXISTS
        "${_qt5Quick3DAssetImport_install_prefix}/lib/libQt5Quick3DAssetImport.dll.a" )
        _populate_Quick3DAssetImport_target_properties(DEBUG "Qt5Quick3DAssetImport.dll" "libQt5Quick3DAssetImport.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Quick3DAssetImport_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Quick3DAssetImport_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Quick3DAssetImport_check_file_exists(${imported_location})
