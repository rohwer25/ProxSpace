...
if (NOT TARGET Qt5::WebSockets)
    ...
    _populate_WebSockets_target_properties(RELEASE "Qt5WebSockets.dll" "libQt5WebSockets.dll.a" FALSE)

    if (EXISTS
        "${_qt5WebSockets_install_prefix}/bin/Qt5WebSockets.dll"
      AND EXISTS
        "${_qt5WebSockets_install_prefix}/lib/libQt5WebSockets.dll.a" )
        _populate_WebSockets_target_properties(DEBUG "Qt5WebSockets.dll" "libQt5WebSockets.dll.a" FALSE)
    endif()
