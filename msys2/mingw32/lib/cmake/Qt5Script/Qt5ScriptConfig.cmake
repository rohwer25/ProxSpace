...
if (NOT TARGET Qt5::Script)
    ...
    _populate_Script_target_properties(RELEASE "Qt5Script.dll" "libQt5Script.dll.a" FALSE)

    if (EXISTS
        "${_qt5Script_install_prefix}/bin/Qt5Script.dll"
      AND EXISTS
        "${_qt5Script_install_prefix}/lib/libQt5Script.dll.a" )
        _populate_Script_target_properties(DEBUG "Qt5Script.dll" "libQt5Script.dll.a" FALSE)
    endif()
