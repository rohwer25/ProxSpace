...
if (NOT TARGET Qt5::Svg)
    ...
    _populate_Svg_target_properties(RELEASE "Qt5Svg.dll" "libQt5Svg.dll.a" FALSE)

    if (EXISTS
        "${_qt5Svg_install_prefix}/bin/Qt5Svg.dll"
      AND EXISTS
        "${_qt5Svg_install_prefix}/lib/libQt5Svg.dll.a" )
        _populate_Svg_target_properties(DEBUG "Qt5Svg.dll" "libQt5Svg.dll.a" FALSE)
    endif()
