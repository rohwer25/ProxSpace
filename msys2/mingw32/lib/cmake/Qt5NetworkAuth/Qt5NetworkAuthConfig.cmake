...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    _populate_NetworkAuth_target_properties(RELEASE "Qt5NetworkAuth.dll" "libQt5NetworkAuth.dll.a" FALSE)

    if (EXISTS
        "${_qt5NetworkAuth_install_prefix}/bin/Qt5NetworkAuth.dll"
      AND EXISTS
        "${_qt5NetworkAuth_install_prefix}/lib/libQt5NetworkAuth.dll.a" )
        _populate_NetworkAuth_target_properties(DEBUG "Qt5NetworkAuth.dll" "libQt5NetworkAuth.dll.a" FALSE)
    endif()
    ...
    macro(_populate_NetworkAuth_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5NetworkAuth_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_NetworkAuth_check_file_exists(${imported_location})
