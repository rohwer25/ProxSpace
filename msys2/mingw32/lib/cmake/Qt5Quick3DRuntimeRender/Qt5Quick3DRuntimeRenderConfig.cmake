...
set(Qt5Quick3DRuntimeRender_VERSION_STRING 5.14.1)
...
if (NOT TARGET Qt5::Quick3DRuntimeRender)
    ...
    set(Qt5Quick3DRuntimeRender_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick3DRuntimeRender_install_prefix}/include/QtQuick3DRuntimeRender/5.14.1"
        "${_qt5Quick3DRuntimeRender_install_prefix}/include/QtQuick3DRuntimeRender/5.14.1/QtQuick3DRuntimeRender"
    )
    ...
    set(_Qt5Quick3DRuntimeRender_MODULE_DEPENDENCIES "Quick3DAssetImport;Quick3DRender;Gui;Core")
    ...
    foreach(_module_dep ${_Qt5Quick3DRuntimeRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.1 ${_Qt5Quick3DRuntimeRender_FIND_VERSION_EXACT}
    ...
    set(_Qt5Quick3DRuntimeRender_LIB_DEPENDENCIES "Qt5::Quick3DAssetImport;Qt5::Quick3DRender;Qt5::Gui;Qt5::Core")
    ...
    _populate_Quick3DRuntimeRender_target_properties(RELEASE "Qt5Quick3DRuntimeRender.dll" "libQt5Quick3DRuntimeRender.dll.a" FALSE)

    if (EXISTS
        "${_qt5Quick3DRuntimeRender_install_prefix}/bin/Qt5Quick3DRuntimeRender.dll"
      AND EXISTS
        "${_qt5Quick3DRuntimeRender_install_prefix}/lib/libQt5Quick3DRuntimeRender.dll.a" )
        _populate_Quick3DRuntimeRender_target_properties(DEBUG "Qt5Quick3DRuntimeRender.dll" "libQt5Quick3DRuntimeRender.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Quick3DRuntimeRender_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Quick3DRuntimeRender_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Quick3DRuntimeRender_check_file_exists(${imported_location})
