...
if (NOT TARGET Qt5::QuickControls2)
    ...
    _populate_QuickControls2_target_properties(RELEASE "Qt5QuickControls2.dll" "libQt5QuickControls2.dll.a" FALSE)

    if (EXISTS
        "${_qt5QuickControls2_install_prefix}/bin/Qt5QuickControls2.dll"
      AND EXISTS
        "${_qt5QuickControls2_install_prefix}/lib/libQt5QuickControls2.dll.a" )
        _populate_QuickControls2_target_properties(DEBUG "Qt5QuickControls2.dll" "libQt5QuickControls2.dll.a" FALSE)
    endif()
    ...
    macro(_populate_QuickControls2_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QuickControls2_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickControls2_check_file_exists(${imported_location})
