...
if (NOT TARGET Qt5::Gamepad)
    ...
    _populate_Gamepad_target_properties(RELEASE "Qt5Gamepad.dll" "libQt5Gamepad.dll.a" FALSE)

    if (EXISTS
        "${_qt5Gamepad_install_prefix}/bin/Qt5Gamepad.dll"
      AND EXISTS
        "${_qt5Gamepad_install_prefix}/lib/libQt5Gamepad.dll.a" )
        _populate_Gamepad_target_properties(DEBUG "Qt5Gamepad.dll" "libQt5Gamepad.dll.a" FALSE)
    endif()
    ...
    macro(_populate_Gamepad_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Gamepad_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Gamepad_check_file_exists(${imported_location})
