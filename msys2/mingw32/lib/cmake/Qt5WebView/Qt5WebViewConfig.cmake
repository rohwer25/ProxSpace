...
if (NOT TARGET Qt5::WebView)
    ...
    _populate_WebView_target_properties(RELEASE "Qt5WebView.dll" "libQt5WebView.dll.a" FALSE)

    if (EXISTS
        "${_qt5WebView_install_prefix}/bin/Qt5WebView.dll"
      AND EXISTS
        "${_qt5WebView_install_prefix}/lib/libQt5WebView.dll.a" )
        _populate_WebView_target_properties(DEBUG "Qt5WebView.dll" "libQt5WebView.dll.a" FALSE)
    endif()
    ...
    macro(_populate_WebView_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5WebView_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebView_check_file_exists(${imported_location})
