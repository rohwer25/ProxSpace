...
if (NOT TARGET Qt5::DataVisualization)
    ...
    _populate_DataVisualization_target_properties(RELEASE "Qt5DataVisualization.dll" "libQt5DataVisualization.dll.a" FALSE)

    if (EXISTS
        "${_qt5DataVisualization_install_prefix}/bin/Qt5DataVisualization.dll"
      AND EXISTS
        "${_qt5DataVisualization_install_prefix}/lib/libQt5DataVisualization.dll.a" )
        _populate_DataVisualization_target_properties(DEBUG "Qt5DataVisualization.dll" "libQt5DataVisualization.dll.a" FALSE)
    endif()
    ...
    macro(_populate_DataVisualization_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5DataVisualization_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_DataVisualization_check_file_exists(${imported_location})
