...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    _populate_XmlPatterns_target_properties(RELEASE "Qt5XmlPatterns.dll" "libQt5XmlPatterns.dll.a" FALSE)

    if (EXISTS
        "${_qt5XmlPatterns_install_prefix}/bin/Qt5XmlPatterns.dll"
      AND EXISTS
        "${_qt5XmlPatterns_install_prefix}/lib/libQt5XmlPatterns.dll.a" )
        _populate_XmlPatterns_target_properties(DEBUG "Qt5XmlPatterns.dll" "libQt5XmlPatterns.dll.a" FALSE)
    endif()
