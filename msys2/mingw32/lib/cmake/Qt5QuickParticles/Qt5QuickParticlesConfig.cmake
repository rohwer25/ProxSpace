...
if (NOT TARGET Qt5::QuickParticles)
    ...
    _populate_QuickParticles_target_properties(RELEASE "Qt5QuickParticles.dll" "libQt5QuickParticles.dll.a" FALSE)

    if (EXISTS
        "${_qt5QuickParticles_install_prefix}/bin/Qt5QuickParticles.dll"
      AND EXISTS
        "${_qt5QuickParticles_install_prefix}/lib/libQt5QuickParticles.dll.a" )
        _populate_QuickParticles_target_properties(DEBUG "Qt5QuickParticles.dll" "libQt5QuickParticles.dll.a" FALSE)
    endif()
