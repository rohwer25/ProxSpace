...
if (NOT TARGET Qt5::3DExtras)
    ...
    _populate_3DExtras_target_properties(RELEASE "Qt53DExtras.dll" "libQt53DExtras.dll.a" FALSE)

    if (EXISTS
        "${_qt53DExtras_install_prefix}/bin/Qt53DExtras.dll"
      AND EXISTS
        "${_qt53DExtras_install_prefix}/lib/libQt53DExtras.dll.a" )
        _populate_3DExtras_target_properties(DEBUG "Qt53DExtras.dll" "libQt53DExtras.dll.a" FALSE)
    endif()
    ...
    macro(_populate_3DExtras_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DExtras_install_prefix}/share/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_3DExtras_check_file_exists(${imported_location})
