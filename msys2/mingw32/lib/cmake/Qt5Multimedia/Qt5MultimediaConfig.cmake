...
if (NOT TARGET Qt5::Multimedia)
    ...
    _populate_Multimedia_target_properties(RELEASE "Qt5Multimedia.dll" "libQt5Multimedia.dll.a" FALSE)

    if (EXISTS
        "${_qt5Multimedia_install_prefix}/bin/Qt5Multimedia.dll"
      AND EXISTS
        "${_qt5Multimedia_install_prefix}/lib/libQt5Multimedia.dll.a" )
        _populate_Multimedia_target_properties(DEBUG "Qt5Multimedia.dll" "libQt5Multimedia.dll.a" FALSE)
    endif()
